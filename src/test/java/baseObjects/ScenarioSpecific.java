...
public class ScenarioSpecific
{
    ...
    public static String resourcePath = "src/test/resources"; //resource folder where json,properties file resides
    public static String dataPropertiesFile = "src/test/resources/Data.properties";//full path of data properties file
